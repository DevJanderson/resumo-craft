...
import { UserDropdown } from "@/components/pages/dashboard/use-dropdown";
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  return (
    <div className="w-full h-screen overflow-hidden grid grid-cols-[280px,1fr] ">
      <aside className="w-full h-full flex flex-col items-center border-r border-muted">
        ...
        <h2 className="text-xl font-semibold" >Resumo Craft</h2>
        </div>
        <NavItems/>
